...
export default function Footer() {
  return (
    <footer className="p-4  sm:p-6 bg-gray-200">
        ...
        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
                ...
                <ul className="text-gray-600 dark:text-gray-400">
                    <li className="mb-4">
                        <a href="https://flowbite.com" className="hover:underline">BlokField</a>
                    </li>
                    <li>
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com" class="hover:underline">BlokField</a>. All Rights Reserved.
        </span>
