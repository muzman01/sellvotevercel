...
import {RightBar,Middle} from "@components/ui/common"
import axios from "axios";



const SellvoteContainer = () => {
    useEffect(() => {
        AOS.init();
        AOS.refresh();
      }, []);
    ...
    return (
        ...
        <BaseLayout>
            ...
            <div className="flex  ml-3 mt-6 space-x-6  mr-4    place-content-center " style={{maxHeight:'100%'}}>
                <Middle />
...
export default SellvoteContainer
